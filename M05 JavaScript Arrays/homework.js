...
function incrementarPorUno(array) {
   ...
   let Elementos = []
   for(let i = 0; i<array.length;i++){
      let sumaElementos = array[i] + 1
      Elementos.push(sumaElementos)
   }
   return Elementos
}
...
function cuentoElementos(array) {
   ...
   // Tu código:
  let elementos = array.filter(n => n > 18) 
...
function todosIguales(array) {
   ...
   // Tu código:
   let iguales = array.every(n => n === array[0])
   return iguales
}
